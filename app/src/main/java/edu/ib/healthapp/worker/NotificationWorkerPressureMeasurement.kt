...
class NotificationWorkerPressureMeasurement(private val context: Context, val params: WorkerParameters): Worker(context,params) {
    ...
    private fun sendNotification() {
        ...
        var builder = NotificationCompat.Builder(context, MainActivity.PRESSURE_MEASUREMENT_CHANEL_ID)
            .setSmallIcon(R.drawable.ic_launcher_background)
            .setContentTitle("$userName $userSurname zmierz ciśnienie")
