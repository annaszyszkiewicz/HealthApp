...
class NotificationWorkerSugarMeasurement(private val context: Context, val params: WorkerParameters): Worker(context,params) {
    ...
    private fun sendNotification() {
        ...
        var builder = NotificationCompat.Builder(context, MainActivity.SUGAR_CHANEL_ID)
            .setSmallIcon(R.drawable.ic_launcher_background)
            .setContentTitle("$userName $userSurname zmierz poziom glukozy")
